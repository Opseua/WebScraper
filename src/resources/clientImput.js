...
async function clientImput(inf = {}) {
    ...
    try {
        let pageValue, leadStatus, res, params;
        ...
        params = { // [INPUT] 'Primeiro Nome'
            'nameSearch': `[INPUT] 'Primeiro Nome'`, 'element': {
                'elementMaxAwaitMil': 20000, 'tag': 'input',
        ...
        if (res.length === 0 || !res[0].ret) { await screenshotAndStop({ 'err': `Não achou o formulário`, 'screenshot': '1', }); }
        ...
        // ESPERAR O POSSÍVEL ALERTA DE ERRO
